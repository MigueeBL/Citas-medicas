                    ...
                    {DIAS.map((dia) => {
                      ...
                      return (
                        <div
                          ...
                          style={{
                            ...styles.diaCard,
                            ...(horario ? styles.diaCardActivo : styles.diaCardVacio),
                          }}
                        >
                          ...
                          {horario ? (
                            <>
                              <div style={styles.diaHora}>{horario.inicio}</div>
                              <div style={styles.diaSep}>—</div>
                              <div style={styles.diaHora}>{horario.fin}</div>
                            </>
                          ) : (
